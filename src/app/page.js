...
<img
          ...
          <button class="mt-6 hover:bg-[#FF00E5] px-4 rounded-full text-gray-950 py-2 bg-[#00FFA2] mr-2"><a href="mailto:robynnthompson@gmail.com" target="_blank" >robynnthompson@gmail.com</a></button>

          <button class="text-gray-950 hover:bg-[#FF00E5] rounded-full  px-4 py-2 bg-[#00FFA2]"><a href="https://calendly.com/robynnthompson/free-initial-client-strategy-meeting?month=2024-05" target="_blank">Schedule a consultation</a></button>
