    ...
    <div className="relative bg-purple-800">
      <div className="mx-auto max-w-7xl lg:flex lg:justify-between lg:px-8 xl:justify-end">
        ...
        <div className="px-6 lg:contents">
          ...
          <p className="text-base font-semibold leading-7 text-white"><span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline-block m-auto text-[#00FFA2]">
...
<img
          ...
          <button class="text-gray-950 px-3 py-2 bg-[#00FFA2]"><a src="https://calendly.com/robynnthompson/free-initial-client-strategy-meeting?month=2024-05">Schedule a consultation</a></button>
