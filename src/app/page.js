...
<img
          ...
          <button class="mt-4 px-3 rounded-2xl text-gray-950 py-2 bg-[#00FFA2]"><a src="mailto:robynnthompson@gmail.com" target="_blank" >robynnthompson@gmail.com</a></button>

          <button class="text-gray-950 rounded-2xl  px-3 py-2 bg-[#00FFA2]"><a src="https://calendly.com/robynnthompson/free-initial-client-strategy-meeting?month=2024-05">Schedule a consultation</a></button>
