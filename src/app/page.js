...
<img
          ...
          <a href="mailto:robynnthompson@gmail.com" target="_blank" ><button class="mt-6 hover:bg-[#FF00E5] text-md px-4 rounded-full text-gray-950 py-2 hover:text-white bg-[#00FFA2] mr-2">robynnthompson@gmail.com</button></a>

          <a href="https://calendly.com/robynnthompson/free-initial-client-strategy-meeting?month=2024-05" target="_blank"><button class=" text-md text-gray-950 hover:bg-[#FF00E5] rounded-full hover:text-white  px-4 py-2 bg-[#00FFA2]">Schedule a consultation</button></a>
          <a href="mailto:robynnthompson@gmail.com" target="_blank" ><button class=" text-md mt-6 hover:bg-[#FF00E5] px-4 rounded-full text-gray-950 py-2 hover:text-white bg-[#00FFA2] mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram inline-block m-auto mr-2" viewBox="0 0 16 16">
