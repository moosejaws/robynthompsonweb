...
<img
          ...
          <a href="https://www.instagram.com/iam_thespark/" target="_blank" ><button class=" text-sm mt-6 hover:bg-[#FF00E5] px-4 rounded-full text-gray-950 py-2 hover:text-white bg-[#00FFA2] mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-instagram inline-block m-auto mr-2 text-[#FF00E5]" viewBox="0 0 16 16">
